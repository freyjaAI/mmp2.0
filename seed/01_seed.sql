...
VALUES 
('0193c5d6-1234-1234-1234-123456789012', 'SPENCER, PAUL EUGENE', '1972-02-01', 0.95, '{}'),
('02aaaaaa-1234-1234-1234-123456789012', 'DANDREA, MICHAEL', '1966-03-15', 0.90, '{}');
...
SELECT person_raw_id, '0193c5d6-1234-1234-1234-123456789012', 0.95
FROM person_raw WHERE src_row_id = 'SP001'
UNION ALL
SELECT person_raw_id, '02aaaaaa-1234-1234-1234-123456789012', 0.90
...
VALUES
('0193c5d6-1234-1234-1234-123456789012', 'criminal', '1997-04-23', 7, 'nc_district_court', '1997CR116288', '{"charge":"Larceny","disposition":"CASE DISPOSED","court":"DISTRICT COURT NC"}'),
('0193c5d6-1234-1234-1234-123456789012', 'ofac', '2024-01-15', 10, 'treasury_ofac', '12345', '{}');

-- Test business
INSERT INTO business_canon (business_canon_id, best_legal_name, best_fein, best_address, confidence_score, flags)
VALUES ('03bbbbbb-1234-1234-1234-123456789012', 'ZOOKS ENTERPRISES CORP', '000000000', '821 CANDLEWOOD LAKE RD S, NEW MILFORD, CT', 0.95, '{}');
